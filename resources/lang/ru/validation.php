...
return [
    ...
    'parent_must_not_be_descendant' => 'Нельзя переместить рубрику внутрь самой себя или её потомка.',
    'immutable_published_at'        => 'Поле :attribute нельзя изменить после публикации.',
